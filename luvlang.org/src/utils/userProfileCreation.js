 ...
 */
export async function createUserProfile(user, userId, photoUrls) {
...
function getSecurePhotoUrl(filename) {
    return `https://storage.luvlang.org/storage/v1/object/public/profile-photos/${filename}`;
}
export async function updateProfilePhotos(user, userId, photoUrls) {
