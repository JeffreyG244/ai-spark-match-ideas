...
export const capturePhotoFromVideo = async (video, canvas) => {
...
export const uploadPhotoToStorage = async (userId, photoCount, blob) => {
...
export const updateUserProfile = async (userId, email, newPhotoUrl) => {
