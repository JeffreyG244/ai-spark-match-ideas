...
export const usePhotoCapture = () => {
    ...
    const capturePhotoFromVideo = async (video, canvas) => {
        return new Promise((resolve, reject) => {
            try {
                ...
                }, 'image/jpeg', 0.85 // Quality setting
                );
            }
            catch (error) {
    ...
    const uploadPhotoToStorage = async (blob) => {
        try {
    ...
    const captureAndUploadPhoto = useCallback(async (videoRef, canvasRef) => {
