...
export const useFaceDetectionLoop = (model, videoRef, isUploading) => {
    ...
    const updateInstructions = (facesFound, attempts) => {
        if (facesFound > 0) {
