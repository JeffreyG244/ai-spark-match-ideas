...
import { Heart, Brain, Shield, Target, MessageCircle, Users, Clock, Trophy, Zap, ArrowRight } from "lucide-react";
...
const HowItWorks = () => {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50">
      <div className="container mx-auto px-6 py-8">
        ...
        <nav className="flex justify-between items-center mb-12">
          ...
          <div className="flex gap-3">
            {!user ? (<Button onClick={() => navigate("/auth")} className="bg-purple-600 hover:bg-purple-700">
                Start Matching
              </Button>) : (<Button onClick={() => navigate("/membership")} className="bg-purple-600 hover:bg-purple-700">
                Upgrade Plan
              </Button>)}
          </div>
        </nav>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-12">
            {steps.map((step, index) => (<div key={index} className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (<Card key={index} className="border-purple-200 hover:shadow-lg transition-shadow">
        ...
        <div className="text-center bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            {!user ? (<Button size="lg" variant="secondary" onClick={() => navigate("/auth")} className="bg-white text-purple-600 hover:bg-gray-100">
                Start Your Journey Free
                <ArrowRight className="h-4 w-4 ml-2"/>
              </Button>) : (<Button size="lg" variant="secondary" onClick={() => navigate("/membership")} className="bg-white text-purple-600 hover:bg-gray-100">
