...
import { Heart, Brain, MessageCircle, Calendar } from 'lucide-react';
...
const Matches = () => {
    ...
    const avgCompatibility = matches.length > 0
        ...
        : 0;
    return (<div className="min-h-screen" style={{ background: 'var(--love-gradient-bg)' }}>
      <NavigationTabs />
      <div className="container mx-auto p-6">
        ...
        {matches.length === 0 ? (<Card className="border-purple-200 text-center py-12">
            <CardContent>
            ...
            {matches.map((match) => {
                ...
                return (<Card key={match.id} className="border-purple-200 hover:border-purple-300 transition-all duration-300 hover:shadow-lg">
                  <CardHeader className="pb-4">
                    <div className="w-full h-48 bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg mb-4 overflow-hidden">
                      <img src={photo} alt={firstName} className="w-full h-full object-cover" onError={(e) => {
