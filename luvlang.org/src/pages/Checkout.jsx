    ...
    return (<div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      <div className="container mx-auto p-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Button onClick={() => navigate('/membership')} variant="outline" size="sm" className="flex items-center gap-2">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className={`mb-6 ${plan.isPopular ? 'border-2 border-purple-500 shadow-lg' : 'border-2 border-yellow-500 shadow-lg'}`}>
            {plan.isPopular && (<div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10">
            ...
            <CardHeader className="text-center">
              ...
              <div className="space-y-2">
                ...
                {billingCycle === 'annual' && savings > 0 && (<p className="text-green-600 font-medium">
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="flex gap-4">
                <Button onClick={() => setBillingCycle('monthly')} variant={billingCycle === 'monthly' ? 'default' : 'outline'} className="flex-1" style={{
            backgroundColor: billingCycle === 'monthly' ? plan.color : undefined
        }}>
                  Monthly - ${plan.monthlyPrice}/month
                </Button>
                <Button onClick={() => setBillingCycle('annual')} variant={billingCycle === 'annual' ? 'default' : 'outline'} className="flex-1" style={{
            backgroundColor: billingCycle === 'annual' ? plan.color : undefined
        }}>
                  Annual - ${plan.annualPrice}/year
                  {savings > 0 && (<span className="ml-2 text-xs bg-green-100 text-green-800 px-2 py-1 rounded">
          ...
          <Card>
            <CardContent className="pt-6">
              <Button onClick={handleCheckout} disabled={isLoading} className="w-full text-lg py-6" style={{ backgroundColor: plan.color }}>
                {isLoading ? (<>
