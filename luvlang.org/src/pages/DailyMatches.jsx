...
const DailyMatches = () => {
    ...
    const { dailyMatches, isLoading, loadDailyMatches, generateDailyMatches, markAsViewed } = useDailyMatches();
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={handleRefreshMatches} disabled={isLoading} className="bg-purple-600 hover:bg-purple-700">
        ...
        {availableMatches.length === 0 ? (<Card className="border-purple-200 text-center py-12">
            <CardContent>
              ...
              <div className="flex gap-4 justify-center">
                ...
                <Button onClick={handleRefreshMatches} variant="outline" disabled={isLoading}>
                  <RefreshCw className={`h-4 w-4 mr-2 ${isLoading ? 'animate-spin' : ''}`}/>
                  Generate Matches
                </Button>
              </div>
            ...
            <div className="flex justify-center">
              <div className="relative w-full max-w-md">
                {currentMatch ? (<div className="relative">
                    <p className="text-center text-sm text-gray-600 mb-4">
                      Swipe left to pass, right to like!
                    </p>
                    <AnimatePresence mode="wait">
                      <SwipeableDailyMatch key={currentMatch.id} match={currentMatch} onSwipe={handleSwipe}/>
                    </AnimatePresence>
                  </div>) : (<Card className="border-purple-200 text-center py-16">
                    <CardContent className="space-y-6">
                      ...
                      <Button onClick={handleRefreshMatches} className="bg-purple-600 hover:bg-purple-700">
